...
import { DrawingState, PreviewBoundingBox, PreviewPolyline } from "context/DrawingContext";

interface GeometryPreviewProps {
  previewItem: DrawingState["previewItem"];
}

const GeometryPreview: React.FC< {previewItem: PreviewBoundingBox | PreviewPolyline}> = ({ previewItem }) => {
